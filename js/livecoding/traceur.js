...
System.register("traceur@0.0.40/src/codegeneration/PureES6Transformer", [], function() {
  ...
  var TypeTransformer = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/TypeTransformer")).TypeTransformer;
  var UniqueIdentifierGenerator = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/UniqueIdentifierGenerator")).UniqueIdentifierGenerator;
  var $__336 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/options")),
...
System.register("traceur@0.0.40/src/codegeneration/module/AttachModuleNameTransformer", [], function() {
  ...
  var ParseTreeTransformer = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/ParseTreeTransformer")).ParseTreeTransformer;
  var $__338 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/syntax/trees/ParseTrees")),
      Module = $__338.Module,
      Script = $__338.Script;
...
System.register("traceur@0.0.40/src/util/TestErrorReporter", [], function() {
  ...
  var $__341 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/ErrorReporter")),
...
System.register("traceur@0.0.40/src/Compiler", [], function() {
  "use strict";
  var __moduleName = "traceur@0.0.40/src/Compiler";
  ...
  var SourceFile = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/syntax/SourceFile")).SourceFile;
  var SourceMapGenerator = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/outputgeneration/SourceMapIntegration")).SourceMapGenerator;
  var ErrorReporter = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/TestErrorReporter")).TestErrorReporter;
  var traceurOptions = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/options")).options;
  var write = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/outputgeneration/TreeWriter")).write;
  function merge(dest) {
    for (var srcs = [],
        $__343 = 1; $__343 < arguments.length; $__343++)
      srcs[$__343 - 1] = arguments[$__343];
...
System.register("traceur@0.0.40/src/runtime/LoaderHooks", [], function() {
  ...
  var UniqueIdentifierGenerator = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/UniqueIdentifierGenerator")).UniqueIdentifierGenerator;
  var $__353 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/url")),
  ...
  ($traceurRuntime.createClass)(LoaderHooks, {
    ...
    fetch: function(load) {
      ...
      return new Promise((function(resolve, reject) {
        if (!load)
          ...
          $__351.fileLoader.load(load.address, resolve, reject);
      }));
    },
    ...
    instantiate: function($__353) {
      var name = $__353.name,
          metadata = $__353.metadata,
          address = $__353.address,
          source = $__353.source,
          sourceMap = $__353.sourceMap;
      return new Promise((function(resolve, reject) {
        resolve(undefined);
      }));
    },
...
System.register("traceur@0.0.40/src/runtime/InterceptOutputLoaderHooks", [], function() {
  ...
  var InterceptOutputLoaderHooks = function InterceptOutputLoaderHooks() {
    for (var args = [],
        $__355 = 0; $__355 < arguments.length; $__355++)
      args[$__355] = arguments[$__355];
  ...
  ($traceurRuntime.createClass)(InterceptOutputLoaderHooks, {instantiate: function($__356) {
      var metadata = $__356.metadata,
          url = $__356.url;
...
System.register("traceur@0.0.40/src/runtime/InternalLoader", [], function() {
  ...
  var LoaderHooks = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/runtime/LoaderHooks")).LoaderHooks;
  var ObjectMap = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/ObjectMap")).ObjectMap;
  var $__359 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/url")),
      canonicalizeUrl = $__359.canonicalizeUrl,
      isAbsolute = $__359.isAbsolute,
      resolveUrl = $__359.resolveUrl;
  var getUid = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/uid")).getUid;
  var toSource = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/outputgeneration/toSource")).toSource;
  var NOT_STARTED = 0;
  var LOADING = 1;
  ...
  var CodeUnit = function CodeUnit(loaderHooks, normalizedName, type, state, name, referrerName, address) {
    ...
    this.promise = new Promise((function(res, rej) {
      $__357.loaderHooks = loaderHooks;
      $__357.normalizedName = normalizedName;
      $__357.type = type;
      $__357.name_ = name;
      $__357.referrerName_ = referrerName;
      $__357.address_ = address;
      $__357.url = InternalLoader.uniqueName(normalizedName, address);
      $__357.uid = getUid();
      $__357.state_ = state || NOT_STARTED;
      $__357.error = null;
      $__357.result = null;
      $__357.data_ = {};
      $__357.dependencies = [];
  ...
  ($traceurRuntime.createClass)(BundledCodeUnit, {
    ...
    evaluate: function() {
      ...
      var normalizedNames = this.deps.map((function(name) {
        return $__357.loaderHooks.normalize(name);
      }));
  ...
  ($traceurRuntime.createClass)(InternalLoader, {
    ...
    load_: function(name, referrerName, address, type) {
      ...
      if (codeUnit.state === TRANSFORMED) {
        ...
        this.loaderHooks.fetch(codeUnit).then((function(text) {
          ...
          $__357.handleCodeUnitLoaded(codeUnit);
          return codeUnit;
        })).catch((function(err) {
          try {
            ...
            codeUnit.err = err;
            $__357.handleCodeUnitLoadError(codeUnit);
          } catch (ex) {
    ...
    handleCodeUnitLoaded: function(codeUnit) {
      ...
      codeUnit.dependencies = moduleSpecifiers.sort().map((function(name) {
        return $__357.getCodeUnit_(name, referrerName, null, 'module');
      }));
      codeUnit.dependencies.forEach((function(dependency) {
        $__357.load(dependency.normalizedName, null, null, 'module');
      }));
    ...
    transformCodeUnit: function(codeUnit) {
      ...
      ($__359 = $traceurRuntime.assertObject(toSource(metadata.transformedTree, this.options, filename)), metadata.transcoded = $__359[0], metadata.sourceMap = $__359[1], $__359);
...
System.register("traceur@0.0.40/src/runtime/Loader", [], function() {
  ...
  ($traceurRuntime.createClass)(Loader, {
    import: function(name) {
      var $__362 = $traceurRuntime.assertObject(arguments[1] !== (void 0) ? arguments[1] : {}),
          referrerName = $__362.referrerName,
          address = $__362.address;
      var $__360 = this;
      return this.internalLoader_.load(name, referrerName, address, 'module').then((function(codeUnit) {
        return $__360.get(codeUnit.normalizedName);
      }));
    },
    ...
    define: function(normalizedName, source) {
      var $__362 = $traceurRuntime.assertObject(arguments[2] !== (void 0) ? arguments[2] : {}),
          address = $__362.address,
          metadata = $__362.metadata;
    ...
    run: function() {
      ...
      if (ready === 'complete' || ready === 'loaded') {
        ...
        document.addEventListener('DOMContentLoaded', (function() {
          return $__363.selectAndProcessScripts(done);
        }), false);
      }
    }
  }, {});
...
System.register("traceur@0.0.40/src/codegeneration/CloneTreeTransformer", [], function() {
  ...
  var ParseTreeTransformer = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/ParseTreeTransformer")).ParseTreeTransformer;
  var $__367 = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/syntax/trees/ParseTrees")),
      BindingIdentifier = $__367.BindingIdentifier,
      BreakStatement = $__367.BreakStatement,
      ContinueStatement = $__367.ContinueStatement,
      DebuggerStatement = $__367.DebuggerStatement,
      EmptyStatement = $__367.EmptyStatement,
      ExportSpecifier = $__367.ExportSpecifier,
      ExportStar = $__367.ExportStar,
      IdentifierExpression = $__367.IdentifierExpression,
      ImportSpecifier = $__367.ImportSpecifier,
      LiteralExpression = $__367.LiteralExpression,
      ModuleSpecifier = $__367.ModuleSpecifier,
      PredefinedType = $__367.PredefinedType,
      PropertyNameShorthand = $__367.PropertyNameShorthand,
      TemplateLiteralPortion = $__367.TemplateLiteralPortion,
      RestParameter = $__367.RestParameter,
      SuperExpression = $__367.SuperExpression,
      ThisExpression = $__367.ThisExpression;
...
System.register("traceur@0.0.40/src/codegeneration/module/createModuleEvaluationStatement", [], function() {
  ...
  var $__368 = Object.freeze(Object.defineProperties(["System.get(", " +'')"], {raw: {value: Object.freeze(["System.get(", " +'')"])}}));
  var parseStatement = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/codegeneration/PlaceholderParser")).parseStatement;
  function createModuleEvaluationStatement(normalizedName) {
    return parseStatement($__368, normalizedName);
  }
...
System.register("traceur@0.0.40/src/runtime/TraceurLoader", [], function() {
  ...
  ($traceurRuntime.createClass)(TraceurLoader, {
    ...
    loadAsScriptAll: function(names) {
      ...
      var $__370 = this;
      return Promise.all(names.map((function(name) {
        return $__370.loadAsScript(name, {
          referrerName: referrerName,
          address: address
        });
      })));
...
System.register("traceur@0.0.40/src/traceur", [], function() {
  ...
  var $__traceur_64_0_46_0_46_40_47_src_47_Compiler__ = System.get("traceur@0.0.40/src/Compiler");
  var ErrorReporter = $traceurRuntime.assertObject(System.get("traceur@0.0.40/src/util/ErrorReporter")).ErrorReporter;
  ...
  return {
    ...
    get Compiler() {
      return $__traceur_64_0_46_0_46_40_47_src_47_Compiler__.Compiler;
    },
    get compile() {
      return $__traceur_64_0_46_0_46_40_47_src_47_Compiler__.compile;
    },
    get util() {
      return util;
    },
