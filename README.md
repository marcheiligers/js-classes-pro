...
The written out talk available as talk.md

## Code editors:

`[Cmd|Ctrl] + 1`, `[Cmd|Ctrl] + 2`, etc., to insert the parts of code
`[Cmd|Ctrl] + R` to Run the code
`[Cmd|Ctrl] + B` to Blur the code editor
`[Cmd|Ctrl] + N` for the next slide (also works on non-code editor pages)
`[Cmd|Ctrl] + P` for the previous slide (ditto)

## Original reveal.js Readme below
